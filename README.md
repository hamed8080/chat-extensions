...
```swift
.package(url: "https://github.com/hamed8080/chat-extensions.git", .upToNextMinor(from: "2.0.1")),
```
...
```ruby
pod "chat-extensions", :git => 'http://pubgi.sandpod.ir/chat/ios/chat-extensions.git', :tag => '2.0.1'
```
<br/>
